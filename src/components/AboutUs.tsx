...
export default function AboutUs({ onNavigate }: AboutUsProps) {
  return (
    <div id="about-us-view" className="bg-[#fafaf9] text-[#1c1c1a]">
      ...
      <section className="relative py-28 bg-brand-dark overflow-hidden" id="about-header">
        ...
        <div className="lg:col-span-7" id="chronicle-detail flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8" id="credentials-box">
            <div className="flex space-x-4">
              ...
              <div>
                <h4 className="font-serif text-sm text-brand-dark font-semibold mb-1">Physician Standard</h4>
            ...
            <div className="flex space-x-4">
              ...
              <div>
                <h4 className="font-serif text-sm text-brand-dark font-semibold mb-1">Bio-Active Yields</h4>
                <p className="font-sans text-stone-500 text-xs leading-relaxed">
      ...
      <section className="py-20 bg-brand-dark text-brand-chalk" id="brand-mission-vision">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div className="pl-0 md:pl-12">
            ...
            <h3 className="font-serif text-2xl sm:text-3xl text-brand-chalk mb-6 font-light">Our Vision</h3>
            <p className="font-sans text-stone-200 text-xs sm:text-sm leading-relaxed mb-6 font-light">
      ...
      <section className="py-24 max-w-7xl mx-auto px-4" id="research-innovation">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8" id="research-pillars">
          ...
          <div className="bg-[#ffffff] rounded-2xl overflow-hidden border border-stone-200/60 shadow-sm" id="pillar-card-1">
            ...
            <div className="p-6">
              <span className="font-mono text-[9px] text-brand-dark uppercase block mb-2 font-bold">PHASE I • PHYTO-STABILIZATION</span>
              <h4 className="font-serif text-lg text-brand-dark mb-3">Green Extraction</h4>
          ...
          <div className="bg-[#ffffff] rounded-2xl overflow-hidden border border-stone-200/60 shadow-sm" id="pillar-card-2">
            ...
            <div className="p-6">
              <span className="font-mono text-[9px] text-brand-dark uppercase block mb-2 font-bold">PHASE II • LIPID ENCAPSULATION</span>
              <h4 className="font-serif text-lg text-brand-dark mb-3">Dermal Bio-Delivery</h4>
              <p className="font-sans text-stone-600 text-xs leading-relaxed">
          ...
          <div className="bg-[#ffffff] rounded-2xl overflow-hidden border border-stone-200/60 shadow-sm" id="pillar-card-3">
            ...
            <div className="p-6">
              <span className="font-mono text-[9px] text-brand-dark uppercase block mb-2 font-bold">PHASE III • CLINICAL SCREENING</span>
              <h4 className="font-serif text-lg text-brand-dark mb-3">Diagnostics & Assays</h4>
              <p className="font-sans text-stone-600 text-xs leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="p-6 sm:w-3/5 flex flex-col justify-between">
                <div>
                  <div className="flex justify-between items-baseline mb-2">
                    <h4 className="font-serif text-lg text-brand-dark font-semibold">Nikesh Baral</h4>
                    <span className="font-mono text-[9px] text-brand-chalk uppercase tracking-widest bg-brand-dark px-2 py-0.5 rounded">CEO</span>
                  </div>
                ...
                <div className="mt-4 pt-4 border-t border-stone-100 flex items-center justify-between">
                  ...
                  <a href="tel:9709157230" className="font-mono text-xs text-brand-dark font-semibold hover:text-[#c5a880] transition-colors">
                    +977 9709157230
                  </a>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl overflow-hidden border border-stone-200/60 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col sm:flex-row h-full">
              ...
              <div className="p-6 sm:w-3/5 flex flex-col justify-between">
                <div>
                  <div className="flex justify-between items-baseline mb-2">
                    <h4 className="font-serif text-lg text-brand-dark font-semibold">Ramesh Timilsena</h4>
                    <span className="font-mono text-[9px] text-brand-chalk uppercase tracking-widest bg-brand-dark px-2 py-0.5 rounded">Management</span>
                  </div>
                ...
                <div className="mt-4 pt-4 border-t border-stone-100 flex items-center justify-between">
                  ...
                  <a href="tel:9709157340" className="font-mono text-xs text-brand-dark font-semibold hover:text-[#c5a880] transition-colors">
                    +977 9709157340
                  </a>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-stone-200/50 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between">
              <div>
                ...
                <div className="p-4">
                  <h4 className="font-serif text-sm font-semibold text-brand-dark">Priyanshu Maharjan</h4>
              ...
              <div className="p-4 pt-0">
                <a href="tel:9802351488" className="block text-center text-[10px] font-mono py-1.5 bg-brand-dark/5 text-brand-dark hover:bg-brand-dark hover:text-brand-gold rounded transition-all font-semibold">
                  Call: 9802351488
                </a>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-stone-200/50 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between">
              <div>
                ...
                <div className="p-4">
                  <h4 className="font-serif text-sm font-semibold text-brand-dark">Shraddha Manandhar</h4>
                  <div className="text-[10px] font-mono text-stone-400 uppercase tracking-widest mt-0.5">HQ Kathmandu</div>
                  <p className="font-sans text-[11px] text-[#c5a880] font-medium mt-1">Field Sales Officer</p>
                </div>
              </div>
              <div className="p-4 pt-0">
                <a href="tel:9818920668" className="block text-center text-[10px] font-mono py-1.5 bg-brand-dark/5 text-brand-dark hover:bg-brand-dark hover:text-brand-gold rounded transition-all font-semibold">
                  Call: 9818920668
                </a>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-stone-200/50 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between">
              <div>
                ...
                <div className="p-4">
                  <h4 className="font-serif text-sm font-semibold text-brand-dark">Bimal Chaudhary</h4>
                  <div className="text-[10px] font-mono text-stone-400 uppercase tracking-widest mt-0.5">Nepalgunj Sector</div>
                  <p className="font-sans text-[11px] text-[#c5a880] font-medium mt-1">Field Sales Officer</p>
                </div>
              </div>
              <div className="p-4 pt-0">
                <a href="tel:9709188315" className="block text-center text-[10px] font-mono py-1.5 bg-brand-dark/5 text-brand-dark hover:bg-brand-dark hover:text-brand-gold rounded transition-all font-semibold">
                  Call: 9709188315
                </a>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-stone-200/50 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between">
              <div>
                ...
                <div className="p-4">
                  <h4 className="font-serif text-sm font-semibold text-brand-dark">Ramesh Shrestha</h4>
                  <div className="text-[10px] font-mono text-stone-400 uppercase tracking-widest mt-0.5">Chitwan Sector</div>
                  <p className="font-sans text-[11px] text-[#c5a880] font-medium mt-1">Field Sales Officer</p>
                </div>
              </div>
              <div className="p-4 pt-0">
                <a href="tel:9802351489" className="block text-center text-[10px] font-mono py-1.5 bg-brand-dark/5 text-brand-dark hover:bg-brand-dark hover:text-brand-gold rounded transition-all font-semibold">
                  Call: 9802351489
                </a>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl overflow-hidden border border-stone-200/50 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between">
              <div>
                ...
                <div className="p-4">
                  <h4 className="font-serif text-sm font-semibold text-brand-dark">Bikash Mandal</h4>
                  <div className="text-[10px] font-mono text-stone-400 uppercase tracking-widest mt-0.5">Biratnagar Sector</div>
                  <p className="font-sans text-[11px] text-[#c5a880] font-medium mt-1">Field Sales Officer</p>
                </div>
              </div>
              <div className="p-4 pt-0">
                <a href="tel:9705429614" className="block text-center text-[10px] font-mono py-1.5 bg-brand-dark/5 text-brand-dark hover:bg-brand-dark hover:text-brand-gold rounded transition-all font-semibold">
                  Call: 9705429614
                </a>
              </div>
            </div>
        ...
        <div>
          ...
          <div className="bg-brand-dark rounded-3xl p-8 sm:p-12 text-white relative overflow-hidden flex flex-col lg:flex-row justify-between items-center gap-8 animate-fade-in">
            ...
            <div className="text-center lg:text-left">
              ...
              <h4 className="font-serif text-2xl text-brand-gold font-semibold mb-3">Shree Krishna Khadgi</h4>
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto shrink-0 justify-center">
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 text-center select-none backdrop-blur-sm min-w-[200px]">
                ...
                <div className="font-serif text-sm font-semibold text-brand-gold">Central Hub & Inventory</div>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 text-center select-none backdrop-blur-sm min-w-[200px]">
      ...
      <section className="py-24 bg-gradient-to-b from-brand-dark/5 to-[#fafaf9]" id="sustainability-ethics">
          ...
          <div id="sustainability-narrative">
            ...
            <div className="space-y-6" id="sustainability-points">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-serif text-xs sm:text-sm text-brand-dark font-semibold">100% Biodegradable Fluid Matrix</h4>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-serif text-xs sm:text-sm text-brand-dark font-semibold">Recyclable Opaline Glassware</h4>
                  <p className="font-sans text-stone-500 text-xs leading-normal">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-serif text-xs sm:text-sm text-brand-dark font-semibold">Zero-Harm Animal Sourcing</h4>
                  <p className="font-sans text-stone-500 text-xs leading-normal">
