...
export default function Gallery({ gallery }: GalleryProps) {
  ...
  return (
    <div id="gallery-view" className="bg-[#fafaf9] text-[#1c1c1a] min-h-screen">
      ...
      <section className="relative py-28 bg-[#0A1C26] text-center overflow-hidden" id="gallery-header">
      ...
      <section className="py-8 bg-white border-b border-stone-200/50 sticky top-20 z-40" id="gallery-filter-controls">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row gap-4 items-center justify-between">
          ...
          <div className="flex items-center space-x-2 text-[#0A1C26]">
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded text-[10px] sm:text-xs tracking-widest uppercase transition-all duration-300 font-sans font-medium whitespace-nowrap cursor-pointer ${
                  filter === cat
                    ...
                    : 'bg-[#FCFAF6] text-stone-500 hover:text-stone-750 border border-stone-200/50'
                }`}
              >
                {cat}
              </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8" id="editorial-grid">
          {filteredItems.map((item) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#0A1C26]/95 via-[#0A1C26]/35 to-transparent z-10"></div>
              ...
              <div className="relative z-20 p-8 sm:p-12 text-white">
                <span className="font-sans text-[10px] tracking-[0.3em] text-[#E5EDA8] uppercase block mb-2 font-bold">
      ...
      <section className="relative h-[550px] flex items-center justify-center overflow-hidden bg-[#0A1C26]" id="editorial-full-banner">
        <div className="absolute inset-0">
          <img 
            ...
            referrerPolicy="no-referrer"
          />
          <div className="absolute inset-0 bg-[#0A1C26]/60"></div>
          <div className="absolute inset-0 bg-gradient-to-t from-[#0A1C26] via-[#0A1C26]/80 to-[#0A1C26]/40"></div>
        </div>
